 ...
 * 
 */
Ext.define('Melisa.drive.ux.uploader.ExtJsUploader', {
    extend : 'Melisa.drive.ux.uploader.AbstractXhrUploader',

    requires : [
        'Melisa.drive.ux.uploader.AbstractXhrUploader',
    ...
    initConnection : function() {
        ...
        if (this.connection instanceof Ext.data.Connection) {
            ...
            conn = Ext.create('Melisa.drive.ux.uploader.data.Connection', {
                disableCaching : true,
                method : this.method,
                url : url,
                timeout : this.timeout,
                defaultHeaders : Ext.applyIf(defaultHeaders, this.getHeaders())
            });
        }
